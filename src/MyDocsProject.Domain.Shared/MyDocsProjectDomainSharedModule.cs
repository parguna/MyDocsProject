...
[DependsOn(typeof(DocsDomainSharedModule))]
    public class MyDocsProjectDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MyDocsProjectGlobalFeatureConfigurator.Configure();
        MyDocsProjectModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MyDocsProjectDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MyDocsProjectResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MyDocsProject");

            options.DefaultResourceType = typeof(MyDocsProjectResource);
        ...
        {
            options.MapCodeNamespace("MyDocsProject", typeof(MyDocsProjectResource));
        });
    }
}
