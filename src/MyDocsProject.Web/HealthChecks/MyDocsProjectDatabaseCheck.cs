...
public class MyDocsProjectDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MyDocsProjectDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
