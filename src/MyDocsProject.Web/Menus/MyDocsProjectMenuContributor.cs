...
namespace MyDocsProject.Web.Menus;

public class MyDocsProjectMenuContributor : IMenuContributor
{
    ...
    {
        var l = context.GetLocalizer<MyDocsProjectResource>();
                
        //Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                MyDocsProjectMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 1
